...
var imgContainer = document.querySelector(".display-img");
var imgs = document.querySelectorAll(".display-img img");


// displaying images using  logo ,web and mobile
function displayImg(par) {
  
  imgContainer.innerHTML = "";
  imgs.forEach((imger) =>
    imger.dataset.name == par
      ? (imgContainer.innerHTML += `
        <img src=${imger.src} alt >
        `)
      : console.log(imger)
  );
}

// displaying images using  all

function displayAllImg(par) {

  imgContainer.innerHTML = "";
  imgs.forEach((imger) =>
    imger.dataset.main == par
      ? (imgContainer.innerHTML += `
          <img src=${imger.src} alt >
          `)
      : console.log(imger)
